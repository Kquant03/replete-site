  ...
  useEffect(() => {
    ...
    function updateFps(currentTime: number) {
      ...
      if (currentTime - lastFpsUpdateTime > 1000) {
        setFps(Math.round((frameCount * 1000) / (currentTime - lastFpsUpdateTime)));
        frameCount = 0;
    ...
    function cleanupParticles() {
      const maxParticles = particleCount * 1.5; // Allow some buffer
    ...
    const cleanupInterval = setInterval(cleanupParticles, 5000);
